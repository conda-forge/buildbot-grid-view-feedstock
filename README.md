...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7326&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/buildbot-grid-view-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `buildbot-grid-view` can be installed with:

```
conda install buildbot-grid-view
```

It is possible to list all of the versions of `buildbot-grid-view` available on your platform with:
